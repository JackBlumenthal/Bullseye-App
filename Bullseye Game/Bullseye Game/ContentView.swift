...
//  Bullseye Game
//
//  Created by Jack Blumenthal on 3/17/20.
...
struct ContentView: View {
    ...
    struct ValueStyle: ViewModifier {
        func body(content: Content) -> some View {
            ...
            .modifier(Shadow())
            .font(Font.custom("Ariel rounded MT Bold", size: 24))
        }
    }
    ...
    struct ButtonSmallTextStyle: ViewModifier {
        func body(content: Content) -> some View {
            return content
            .foregroundColor(Color.black)
            .font(Font.custom("Ariel rounded MT Bold", size: 12))
        }
    }
    ...
    var body: some View {
        VStack {
            ...
            //Score row
                ...
                // Add a buffer from the bottom of the view
                .padding(.bottom, 20)
        }
