//
//  AboutView.swift
//  Bullseye Game_SwiftUI
//
//  Created by Jack Blumenthal on 3/23/20.
//  Copyright © 2020 Jack Blumenthal. All rights reserved.
//
    ...
    var body: some View {
        ...
        Group {
            ...
            VStack {
                ...
                Text("Your goal is to place the slider as close as possible to the target value. The closer you are, the more points you earn.").modifier(AboutBodyStyle())
